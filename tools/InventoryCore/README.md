...
The Limbus final-chest target identifiers were validated against live packets
and cross-checked with Superwarp's Limbus support. Superwarp is by Akaden and
credits its Apollyon/Temenos support to Staticvoid; no Superwarp source code is
bundled here.
