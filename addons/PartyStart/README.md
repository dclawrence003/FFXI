...
Choosing a tactical profile by itself (for example `//pstart physical` or
...
physical/master profiles retain all six composition attackers. The Ambuscade
...
- In `master`, Sentinel is attempted only after Flash lands on the current
  target or after a five-second establishment fallback. V1 suppresses that
