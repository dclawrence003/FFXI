...
| [LimbusTracker](addons/LimbusTracker/) | Windower addon | Compact in-game self/roster display for InventoryCore's Limbus rotation data | InventoryCore companion |
